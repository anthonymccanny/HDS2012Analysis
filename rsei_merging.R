...
load_rsei_agg <- function(
  agg_path = "Data/Non_HDS/RSEI/aggmicro2022_2020.csv",
  cache_path = "Data/Non_HDS/RSEI/rsei_agg_2020.rds",
  refresh = FALSE
) {
...
load_rsei_grid_centroids <- function(
  bottom_dbf = "Data/Non_HDS/RSEI/poly_gc14_conus_810m_bottom.dbf",
  top_dbf = "Data/Non_HDS/RSEI/poly_gc14_conus_810m_top.dbf",
  cache_path = "Data/Non_HDS/RSEI/rsei_grid_centroids.rds",
  refresh = FALSE
) {
  # Return cached data if available and not forcing refresh
  if (!refresh && file.exists(cache_path)) {
...
build_rsei_grid_lookup <- function(
  ...
  bottom_dbf = "Data/Non_HDS/RSEI/poly_gc14_conus_810m_bottom.dbf",
  top_dbf = "Data/Non_HDS/RSEI/poly_gc14_conus_810m_top.dbf",
  agg_cache = "Data/Non_HDS/RSEI/rsei_agg_2020.rds",
  grid_cache = "Data/Non_HDS/RSEI/rsei_grid_centroids.rds",
  lookup_cache = "Data/Non_HDS/RSEI/rsei_grid_lookup_2020.rds",
  refresh = FALSE
) {
...
match_rsei_polygon <- function(
  ...
  prefix = "rsei_",
  keep_cell = FALSE,
  bottom_shp = "Data/Non_HDS/RSEI/poly_gc14_conus_810m_bottom.shp",
  top_shp = "Data/Non_HDS/RSEI/poly_gc14_conus_810m_top.shp",
  lookup = NULL,
  ...
) {
  # Validate input columns exist
