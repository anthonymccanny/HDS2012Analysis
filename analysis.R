...
write_table("Tables/table5.tex", latex_table(table_rows))
...
write_table(
  "Appendix_Tables/tableA1_expanded_racial_composition.tex",
  latex_table_multi(
    appendix_a1_rows,
...
family_aux_files <- c(
  "Appendix_Tables/tableA2_white_family_status.tex",
  "Appendix_Tables/tableA3_black_family_status.tex",
  "Appendix_Tables/tableA4_hispanic_family_status.tex",
  "Appendix_Tables/tableA5_asian_family_status.tex"
)
...
run_race_control_table(
  table8a_outcomes,
  table8a_labels,
  "Appendix_Tables/tableA6_school_safety_race_controls.tex",
...
run_race_control_table(
  table8b_outcomes,
  table8b_labels,
  "Appendix_Tables/tableA7_acs_race_controls.tex",
...
run_race_control_table(
  table9_outcomes,
  table9_labels,
  "Appendix_Tables/tableA8_pollution_race_controls.tex",
...
write_table(
  "Appendix_Tables/tableA9_income_race_controls.tex",
  latex_table_race_only(
    appendix_a9_rows,
...
write.csv(
  ...
  "Appendix_Tables/hispanic_tester_proxy_summary.csv",
  row.names = FALSE
)
...
write.csv(
  ...
  "Appendix_Tables/hispanic_tester_text_fields.csv",
  row.names = FALSE
)
...
writeLines(hispanic_note_lines, "Appendix_Tables/hispanic_tester_proxy_note.txt")
...
site_market_lookup <- cleaned_data %>%
  ...
  arrange(site)
write.csv(site_market_lookup, "Appendix_Tables/site_market_lookup.csv", row.names = FALSE)
...
write.csv(
  market_coef_summary,
  "Appendix_Tables/market_racial_share_heterogeneity.csv",
  row.names = FALSE
)
...
write_table(
  "Appendix_Tables/tableA10_black_market_highlights.tex",
  latex_table_custom(
    appendix_a10_rows,
    outcome_labels = market_labels,
